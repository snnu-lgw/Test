...
#############################################################################################################################
    ...
    Global_variable.beta = int(sys.argv[5])
    init_var()  #初始化变量
...
#############################################################################################################################
    ...
    Diversity, Average_Courseware_Support_Rate, Difference = Global_variable.Greedy(Global_variable.N,Global_variable.U,Global_variable.utype)
    s2 = time.time()
    t1 = s2 - s1
